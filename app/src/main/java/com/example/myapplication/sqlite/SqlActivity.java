    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.insert:
                ...
                // 向该对象中插入键值对
                values1.put("id", 2);
                values1.put("name", "carson2");

                // 调用insert()方法将数据插入到数据库当中
                sqliteDatabase1.insert("user", null, values1);

                 //sqliteDatabase1.execSQL("insert into user (id,name) values (3,'carson3')");
            ...
            case R.id.query:
                ...
                // 创建DatabaseHelper对象
                MySQLiteOpenHelper dbHelper4 = new MySQLiteOpenHelper(SqlActivity.this,"test_carson",2);
            ...
            case R.id.modify:
                ...
                MySQLiteOpenHelper dbHelper2 = new MySQLiteOpenHelper(SqlActivity.this,"test_carson", 2);
                ...
                // 调用update方法修改数据库
                sqliteDatabase2.update("user", values2, "id=?", new String[]{"2"});
            ...
            case R.id.delete:
                ...
                // 创建DatabaseHelper对象
                MySQLiteOpenHelper dbHelper3 = new MySQLiteOpenHelper(SqlActivity.this,"test_carson",2);
            ...
            case R.id.delete_database:
                ...
                MySQLiteOpenHelper dbHelper5 = new MySQLiteOpenHelper(SqlActivity.this,
                        "test_carson",2);
